...
* Databasen för Lotto innehåller historisk data för alla resultat mellan 1999-10-06 till 2024-07-24. Äldre resultat från spelstart 1980-09-06 och 1999-10-02 är arkiverade som ”legacy” då resultaten bygger på föråldrade spelregler.

* Databasen för Joker innehåller historisk data mellan 1984-09-15 och 2024-07-24.

* Databasen för Eurojackpot innehåller historisk data från spelstart 2012-03-23 till 2024-07-23.

* Databasen för Vikinglotto innehåller historisk data från senaste spelregeländring 2017-05-24 till 2024-07-24. Äldre resultat mellan 1993-03-17 och 2017-05-17 är arkiverade som ”legacy” då resultaten bygger på föråldrade spelregler.
